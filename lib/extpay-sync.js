 ...
 *     from `now`. Take MAX with any still-active premiumUntil so an existing
 *     grant or grace window is not shortened.
 *  2. user.paid === false AND current entitlement is still active

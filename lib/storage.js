...
export async function readCarts() {
  ...
  // Backfill fields added after the original cart shape was set. Done lazily
  // in memory; persistence happens naturally on the next write.
  backfillLastUsedAt(carts);
  return backfillCartSyncFields(carts);
}

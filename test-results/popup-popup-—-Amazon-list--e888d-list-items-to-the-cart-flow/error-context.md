...
- Name: popup.spec.js >> popup — Amazon list dashboard >> Add All sends the loaded wishlist items to the cart flow
- Location: tests/e2e/popup.spec.js:100:3

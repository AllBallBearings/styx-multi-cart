...
- Name: popup.spec.js >> popup — managing existing carts >> renders seeded carts in order with correct counts and host meta
- Location: tests/e2e/popup.spec.js:163:3

...
- Name: popup.spec.js >> popup — moving items between carts >> moving the last item out deletes the now-empty source cart
- Location: tests/e2e/popup.spec.js:529:3

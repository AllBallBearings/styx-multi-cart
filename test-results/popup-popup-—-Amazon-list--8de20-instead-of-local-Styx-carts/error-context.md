...
- Name: popup.spec.js >> popup — Amazon list dashboard >> renders Amazon lists instead of local Styx carts
- Location: tests/e2e/popup.spec.js:43:3

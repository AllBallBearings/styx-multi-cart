...
- Name: popup.spec.js >> popup — saving carts >> Save sends MC_SAVE_CURRENT with the entered name and renders the new row
- Location: tests/e2e/popup.spec.js:37:3

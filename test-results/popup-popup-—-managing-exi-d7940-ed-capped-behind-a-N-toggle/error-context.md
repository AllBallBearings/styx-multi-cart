...
- Name: popup.spec.js >> popup — managing existing carts >> renders one tile per item (placeholders included), capped behind a +N toggle
- Location: tests/e2e/popup.spec.js:194:3

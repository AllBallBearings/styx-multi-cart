...
- Name: popup.spec.js >> popup — settings toggles >> developer mode is hidden until the settings unlock code is typed
- Location: tests/e2e/popup.spec.js:562:3

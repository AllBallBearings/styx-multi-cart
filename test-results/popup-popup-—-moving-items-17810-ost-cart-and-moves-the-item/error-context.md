...
- Name: popup.spec.js >> popup — moving items between carts >> creating a destination from the move modal creates a same-host cart and moves the item
- Location: tests/e2e/popup.spec.js:493:3

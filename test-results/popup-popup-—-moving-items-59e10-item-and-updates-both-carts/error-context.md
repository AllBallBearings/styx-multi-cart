...
- Name: popup.spec.js >> popup — moving items between carts >> picking a destination moves the item and updates both carts
- Location: tests/e2e/popup.spec.js:473:3

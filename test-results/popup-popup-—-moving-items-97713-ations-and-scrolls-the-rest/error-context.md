...
- Name: popup.spec.js >> popup — moving items between carts >> move modal expands for several destinations and scrolls the rest
- Location: tests/e2e/popup.spec.js:432:3

...
- Name: popup.spec.js >> popup — saving carts >> Save with a blank name falls back to the date-based default
- Location: tests/e2e/popup.spec.js:58:3

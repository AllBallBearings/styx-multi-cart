...
- Name: popup.spec.js >> popup — saving carts >> refreshes when carts change in storage while the popup is open
- Location: tests/e2e/popup.spec.js:101:3

...
- Name: popup.spec.js >> popup — managing existing carts >> switch cart confirmation explains that the Amazon cart is replaced
- Location: tests/e2e/popup.spec.js:231:3

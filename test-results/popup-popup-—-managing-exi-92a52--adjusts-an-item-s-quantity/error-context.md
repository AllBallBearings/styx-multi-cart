...
- Name: popup.spec.js >> popup — managing existing carts >> the count badge popover adjusts an item's quantity
- Location: tests/e2e/popup.spec.js:363:3

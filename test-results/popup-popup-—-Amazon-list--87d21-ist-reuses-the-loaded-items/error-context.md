...
- Name: popup.spec.js >> popup — Amazon list dashboard >> collapsing and reopening a list reuses the loaded items
- Location: tests/e2e/popup.spec.js:82:3

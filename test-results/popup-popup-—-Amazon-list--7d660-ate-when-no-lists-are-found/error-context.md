...
- Name: popup.spec.js >> popup — Amazon list dashboard >> shows the signed-out/empty state when no lists are found
- Location: tests/e2e/popup.spec.js:121:3

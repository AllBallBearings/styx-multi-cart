...
- Name: popup.spec.js >> popup — managing existing carts >> delete is cancelled when the user dismisses the confirm dialog
- Location: tests/e2e/popup.spec.js:294:3

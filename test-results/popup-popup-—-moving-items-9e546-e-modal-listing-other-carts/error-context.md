...
- Name: popup.spec.js >> popup — moving items between carts >> clicking an item thumbnail opens the move modal listing other carts
- Location: tests/e2e/popup.spec.js:418:3

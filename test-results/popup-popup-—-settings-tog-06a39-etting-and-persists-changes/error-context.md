...
- Name: popup.spec.js >> popup — settings toggles >> intercept toggle reflects stored setting and persists changes
- Location: tests/e2e/popup.spec.js:580:3

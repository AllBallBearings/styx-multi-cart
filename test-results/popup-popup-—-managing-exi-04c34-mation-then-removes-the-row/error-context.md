...
- Name: popup.spec.js >> popup — managing existing carts >> delete prompts for confirmation, then removes the row
- Location: tests/e2e/popup.spec.js:273:3

...
- Name: popup.spec.js >> popup — managing existing carts >> the tile X removes an item instantly (no confirm) when others remain
- Location: tests/e2e/popup.spec.js:311:3

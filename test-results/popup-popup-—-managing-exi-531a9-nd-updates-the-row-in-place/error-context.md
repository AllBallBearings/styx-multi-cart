...
- Name: popup.spec.js >> popup — managing existing carts >> rename emits MC_RENAME_CART and updates the row in place
- Location: tests/e2e/popup.spec.js:251:3

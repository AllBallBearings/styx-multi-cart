# Chrome Web Store — Listing Copy (British English)

British-spelling variant of `STORE-LISTING.md` for the en_GB store listing. The "Notes for reviewer / permissions justification" section is intentionally omitted here — paste that straight from `STORE-LISTING.md` if the dashboard asks for it once (it isn't per-locale).

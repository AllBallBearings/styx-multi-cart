...
|------|------------------------|------|--------|
| `product-logo.svg` | Product logo master (also `product-logo-small.svg` for 16–48px and `product-logo-square.svg` for the iOS-style icon) | SVG, scalable | ✅ done — generated by `_build_logo.py` |
| `product-logo-512.png` | Stripe / website product logo | 512×512 PNG | ✅ done — regenerate via `python3 store-assets/_build_logo.py && node store-assets/_render_logo_assets.mjs` |
| `product-logo-1024.png` | High-resolution product logo | 1024×1024 PNG | ✅ done — regenerate via `python3 store-assets/_build_logo.py && node store-assets/_render_logo_assets.mjs` |
| `product-logo-2048.png` | Extra-large product logo | 2048×2048 PNG | ✅ done — regenerate via `python3 store-assets/_build_logo.py && node store-assets/_render_logo_assets.mjs` |
